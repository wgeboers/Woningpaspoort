...
namespace Woningpaspoort.View.Controls;
...
public partial class TabBarView : ContentView
{
    ...
    public TabBarView()
    {
        ...
        {
            App.Current.Resources.TryGetValue("Gray500", out object primaryColor);
            App.Current.Resources.TryGetValue("Gray600", out object secondaryColor);
